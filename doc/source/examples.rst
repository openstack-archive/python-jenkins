...
The is an example showing how to connect to a Jenkins instance and retrieving the
...
the the Jenkins Authentication_ wiki page for details about how a user can
generate an API token. Once you have an API token you can pass the API token
instead of real password while creating a Jenkins instance.
...
This is an example showing how to retrieve Jenkins plugins info.
...
are installed on the Jenkins server.
...
This is an example showing how to retrieve info on the Jenkins queue.
