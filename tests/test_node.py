...
class JenkinsGetNodesTest(JenkinsNodesTestBase):
    ...
    def test_return_invalid_json(self, jenkins_mock):
        ...
        self.assertEqual(
            ...
            '{0}/computer/api/json'.format(self.base_url))
        self.assertEqual(
    ...
    def test_raise_HTTPError(self, jenkins_mock):
        jenkins_mock.side_effect = jenkins.HTTPError(
            '{0}/job/TestJob'.format(self.base_url),
            code=401,
...
class JenkinsGetNodeInfoTest(JenkinsNodesTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args[0][0].get_full_url(),
            '{0}/computer/test%20node/api/json?depth=0'.format(self.base_url))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_return_invalid_json(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args[0][0].get_full_url(),
            '{0}/computer/test_node/api/json?depth=0'.format(self.base_url))
        self.assertEqual(
            str(context_manager.exception),
...
class JenkinsDeleteNodeTest(JenkinsNodesTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            ...
            '{0}/computer/test%20node/doDelete'.format(self.base_url))
    ...
    def test_failed(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[1][0][0].get_full_url(),
            '{0}/computer/test_node/doDelete'.format(self.base_url))
        self.assertEqual(
            str(context_manager.exception),
...
class JenkinsCreateNodeTest(JenkinsNodesTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            ...
            '{0}/computer/doCreateItem'.format(self.base_url))
