...
class JenkinsBuildConsoleTest(JenkinsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            ...
            u'{0}/job/Test%20Job/52/consoleText'.format(self.base_url))
    ...
    def test_in_folder(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args[0][0].get_full_url(),
            u'{0}/job/a%20Folder/job/Test%20Job/52/consoleText'.format(self.base_url))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_raise_HTTPError(self, jenkins_mock):
        jenkins_mock.side_effect = jenkins.HTTPError(
            '{0}/job/TestJob/52/consoleText'.format(self.base_url),
            code=401,
        ...
        self.assertEqual(
            jenkins_mock.call_args[0][0].get_full_url(),
            u'{0}/job/TestJob/52/consoleText'.format(self.base_url))
        self.assertEqual(
            str(context_manager.exception),
            'job[TestJob] number[52] does not exist')
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_in_folder_raise_HTTPError(self, jenkins_mock):
        jenkins_mock.side_effect = jenkins.HTTPError(
            '{0}/job/a%20Folder/job/TestJob/52/consoleText'.format(self.base_url),
            code=401,
            msg="basic auth failed",
            hdrs=[],
            fp=None)
        ...
        self.assertEqual(
            jenkins_mock.call_args[0][0].get_full_url(),
            u'{0}/job/a%20Folder/job/TestJob/52/consoleText'.format(self.base_url))
        self.assertEqual(
            str(context_manager.exception),
            'job[a Folder/TestJob] number[52] does not exist')
        self._check_requests(jenkins_mock.call_args_list)
...
class JenkinsBuildInfoTest(JenkinsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args[0][0].get_full_url(),
            u'{0}/job/Test%20Job/52/api/json?depth=0'.format(self.base_url))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_in_folder(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args[0][0].get_full_url(),
            u'{0}/job/a%20Folder/job/Test%20Job/52/api/json?depth=0'.format(self.base_url))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_raise_HTTPError(self, jenkins_mock):
        jenkins_mock.side_effect = jenkins.HTTPError(
            '{0}/job/TestJob/api/json?depth=0'.format(self.base_url),
            code=401,
            msg="basic auth failed",
            hdrs=[],
            fp=None)
    ...
    def test_in_folder_raise_HTTPError(self, jenkins_mock):
        jenkins_mock.side_effect = jenkins.HTTPError(
            '{0}/job/a%20Folder/job/TestJob/api/json?depth=0'.format(self.base_url),
            code=401,
            msg="basic auth failed",
            hdrs=[],
            fp=None)
...
class JenkinsStopBuildTest(JenkinsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args[0][0].get_full_url(),
            u'{0}/job/Test%20Job/52/stop'.format(self.base_url))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_in_folder(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args[0][0].get_full_url(),
            u'{0}/job/a%20Folder/job/Test%20Job/52/stop'.format(self.base_url))
        self._check_requests(jenkins_mock.call_args_list)
