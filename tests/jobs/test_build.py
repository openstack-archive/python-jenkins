...
class JenkinsBuildJobTest(JenkinsJobsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(jenkins_mock.call_args[0][0].get_full_url(),
                         u'{0}/job/Test%20Job/build'.format(self.base_url))
    ...
    def test_in_folder(self, jenkins_mock):
        ...
        self.assertEqual(jenkins_mock.call_args[0][0].get_full_url(),
                         u'{0}/job/a%20Folder/job/Test%20Job/build'.format(self.base_url))
        self.assertEqual(build_info, {'foo': 'bar'})
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_with_token(self, jenkins_mock):
        ...
        self.assertEqual(jenkins_mock.call_args[0][0].get_full_url(),
                         u'{0}/job/TestJob/build?token=some_token'.format(self.base_url))
        self.assertEqual(build_info, {'foo': 'bar'})
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_in_folder_with_token(self, jenkins_mock):
        ...
        self.assertEqual(jenkins_mock.call_args[0][0].get_full_url(),
                         u'{0}/job/a%20Folder/job/TestJob/build?token=some_token'.format(self.base_url))
        self.assertEqual(build_info, {'foo': 'bar'})
        self._check_requests(jenkins_mock.call_args_list)
