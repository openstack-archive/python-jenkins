...
class JenkinsGetJobNameTest(JenkinsJobsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            ...
            u'{0}/job/Test%20Job/api/json?tree=name'.format(self.base_url))
    ...
    def test_in_folder(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args[0][0].get_full_url(),
            u'{0}/job/a%20Folder/job/Test%20Job/api/json?tree=name'.format(self.base_url))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_return_none(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args[0][0].get_full_url(),
            u'{0}/job/TestJob/api/json?tree=name'.format(self.base_url))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_in_folder_return_none(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args[0][0].get_full_url(),
            u'{0}/job/a%20Folder/job/TestJob/api/json?tree=name'.format(self.base_url))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_unexpected_job_name(self, jenkins_mock):
        ...
        self.assertEqual(
            ...
            '{0}/job/TestJob/api/json?tree=name'.format(self.base_url))
        self.assertEqual(
    ...
    def test_in_folder_unexpected_job_name(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[0][0][0].get_full_url(),
            '{0}/job/a%20Folder/job/TestJob/api/json?tree=name'.format(self.base_url))
        self.assertEqual(
            str(context_manager.exception),
