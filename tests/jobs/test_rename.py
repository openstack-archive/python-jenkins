...
class JenkinsRenameJobTest(JenkinsJobsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            ...
            '{0}/job/Test%20Job/doRename?newName=Test%20Job_2'.format(self.base_url))
    ...
    def test_in_folder(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[0][0][0].get_full_url(),
            '{0}/job/a%20Folder/job/Test%20Job/doRename?newName=Test%20Job_2'.format(self.base_url))
        self.assertTrue(self.j.job_exists('Test Job_2'))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_failed(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[0][0][0].get_full_url(),
            '{0}/job/TestJob/doRename?newName=TestJob_2'.format(self.base_url))
        self.assertEqual(
    ...
    def test_in_folder_failed(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[0][0][0].get_full_url(),
            '{0}/job/a%20Folder/job/TestJob/doRename?newName=TestJob_2'.format(self.base_url))
        self.assertEqual(
            str(context_manager.exception),
