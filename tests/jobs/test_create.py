...
class JenkinsCreateJobTest(JenkinsJobsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            ...
            '{0}/createItem?name=Test%20Job'.format(self.base_url))
    ...
    def test_in_folder(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[1][0][0].get_full_url(),
            '{0}/job/a%20Folder/createItem?name=Test%20Job'.format(self.base_url))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_failed(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[1][0][0].get_full_url(),
            '{0}/createItem?name=TestJob'.format(self.base_url))
        self.assertEqual(
            str(context_manager.exception),
    ...
    def test_failed_in_folder(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[1][0][0].get_full_url(),
            '{0}/job/a%20Folder/createItem?name=TestJob'.format(self.base_url))
        self.assertEqual(
            str(context_manager.exception),
