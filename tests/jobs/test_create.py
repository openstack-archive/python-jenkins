...
class JenkinsCreateJobTest(JenkinsJobsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            ...
            self.makeUrl('createItem?name=Test%20Job'))
    ...
    def test_in_folder(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[1][0][0].get_full_url(),
            self.makeUrl('job/a%20Folder/createItem?name=Test%20Job'))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_failed(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[1][0][0].get_full_url(),
            self.makeUrl('createItem?name=TestJob'))
        self.assertEqual(
            str(context_manager.exception),
    ...
    def test_failed_in_folder(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[1][0][0].get_full_url(),
            self.makeUrl('job/a%20Folder/createItem?name=TestJob'))
        self.assertEqual(
            str(context_manager.exception),
