...
class JenkinsCopyJobTest(JenkinsJobsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            ...
            self.makeUrl('createItem?name=Test%20Job_2&mode=copy&from=Test%20Job'))
    ...
    def test_in_folder(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[0][0][0].get_full_url(),
            self.makeUrl('job/a%20Folder/createItem?name=Test%20Job_2'
    ...
    def test_failed(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[0][0][0].get_full_url(),
            self.makeUrl('createItem?name=TestJob_2&mode=copy&from=TestJob'))
        self.assertEqual(
    ...
    def test_in_folder_failed(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[0][0][0].get_full_url(),
            self.makeUrl('job/a%20Folder/createItem?name=TestJob_2&mode=copy'
                         '&from=TestJob'))
        self.assertEqual(
            str(context_manager.exception),
