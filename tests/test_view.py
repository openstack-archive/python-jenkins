...
class JenkinsGetViewNameTest(JenkinsViewsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            ...
            u'{0}/view/Test%20View/api/json?tree=name'.format(self.base_url))
    ...
    def test_return_none(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args[0][0].get_full_url(),
            u'{0}/view/TestView/api/json?tree=name'.format(self.base_url))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_unexpected_view_name(self, jenkins_mock):
        ...
        self.assertEqual(
            ...
            '{0}/view/TestView/api/json?tree=name'.format(self.base_url))
        self.assertEqual(
...
class JenkinsGetViewsTest(JenkinsViewsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args[0][0].get_full_url(),
            u'{0}/api/json'.format(self.base_url))
        self._check_requests(jenkins_mock.call_args_list)
...
class JenkinsDeleteViewTest(JenkinsViewsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[0][0][0].get_full_url(),
            '{0}/view/Test%20View/doDelete'.format(self.base_url))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_failed(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[0][0][0].get_full_url(),
            '{0}/view/TestView/doDelete'.format(self.base_url))
        self.assertEqual(
            str(context_manager.exception),
...
class JenkinsCreateViewTest(JenkinsViewsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            ...
            '{0}/createView?name=Test%20View'.format(self.base_url))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_failed(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[1][0][0].get_full_url(),
            '{0}/createView?name=TestView'.format(self.base_url))
        self.assertEqual(
            str(context_manager.exception),
...
class JenkinsReconfigViewTest(JenkinsViewsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(jenkins_mock.call_args[0][0].get_full_url(),
                         u'{0}/view/Test%20View/config.xml'.format(self.base_url))
        self._check_requests(jenkins_mock.call_args_list)
