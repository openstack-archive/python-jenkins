...
class JenkinsGetViewNameTest(JenkinsViewsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            ...
            self.makeUrl('view/Test%20View/api/json?tree=name'))
    ...
    def test_return_none(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args[0][0].get_full_url(),
            self.makeUrl('view/TestView/api/json?tree=name'))
        self._check_requests(jenkins_mock.call_args_list)
...
class JenkinsDeleteViewTest(JenkinsViewsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[0][0][0].get_full_url(),
            self.makeUrl('view/Test%20View/doDelete'))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_failed(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[0][0][0].get_full_url(),
            self.makeUrl('view/TestView/doDelete'))
        self.assertEqual(
            str(context_manager.exception),
...
class JenkinsCreateViewTest(JenkinsViewsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(
            ...
            self.makeUrl('createView?name=Test%20View'))
        self._check_requests(jenkins_mock.call_args_list)
    ...
    def test_failed(self, jenkins_mock):
        ...
        self.assertEqual(
            jenkins_mock.call_args_list[1][0][0].get_full_url(),
            self.makeUrl('createView?name=TestView'))
        self.assertEqual(
            str(context_manager.exception),
...
class JenkinsReconfigViewTest(JenkinsViewsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.assertEqual(jenkins_mock.call_args[0][0].get_full_url(),
                         self.makeUrl('view/Test%20View/config.xml'))
        self._check_requests(jenkins_mock.call_args_list)
