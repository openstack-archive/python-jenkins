...
class JenkinsGetJobsTest(JenkinsJobsTestBase):
    ...
    def test_get_jobs_folders_simple(self, jenkins_mock):
        response = build_jobs_list_responses(self.jobs_in_folder,
                                             'http://example.com/')
    ...
    @patch.object(jenkins.Jenkins, 'jenkins_open')
    def test_get_jobs_folders_multi_level(self, jenkins_mock):
    ...
    @patch.object(jenkins.Jenkins, 'jenkins_open')
    def test_get_jobs_folders_depth(self, jenkins_mock):
        response = build_jobs_list_responses(
            self.jobs_in_multiple_folders, 'http://example.com/')
        jenkins_mock.side_effect = iter(response)
