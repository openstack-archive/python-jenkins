...
class JenkinsJobsTestBase(JenkinsTestBase):
    ...
    def setUp(self):
        super(JenkinsJobsTestBase, self).setUp()
        self.matrix_config_xml = """
            <matrix-project>
                <actions/>
...
class JenkinsCreateJobTest(JenkinsJobsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.j.create_job(u'Test Job', self.matrix_config_xml)
    ...
    def test_already_exists(self, jenkins_mock):
        ...
        with self.assertRaises(jenkins.JenkinsException) as context_manager:
            self.j.create_job(u'TestJob', self.matrix_config_xml)
        self.assertEqual(
...
class JenkinsReconfigJobTest(JenkinsJobsTestBase):
    ...
    def test_simple(self, jenkins_mock):
        ...
        self.j.reconfig_job(u'Test Job', self.matrix_config_xml)
